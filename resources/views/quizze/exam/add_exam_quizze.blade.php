...
@section('content')
    ...
    <div class="content">
        <!-- Bootstrap Design -->
        <h2 class="content-heading">Add Quizze Exam</h2>
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Quizze Exam Add</h3>
                    ...
                    <div class="block-content">
                        ...
                        <form action="{{route('quizze.exam.add.quizze.exam')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exam_title">Exam Title<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exam_title" name="exam_title" placeholder="Enter Exam Title" >
                                    </div>
