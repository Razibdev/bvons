    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">View Doctor Officer Details </h3>
            </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    @foreach($bvonRegisterHistory as $doctor)
                        <tr>
                            ...
                            <td class="text-center"> @if(!empty($doctor->district)) {{ $doctor->district->user->email}} @elseif(!empty($doctor->upazilla)) {{ $doctor->upazilla->user->email }} @elseif(!empty($doctor->field))  {{ $doctor->field->user->email }} @endif   </td>
