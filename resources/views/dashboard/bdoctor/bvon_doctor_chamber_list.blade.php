            ...
            <div class="block-content block-content-full">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    @foreach($chambers as $chamber)
                        <tr>
                            <td class="text-center">{{$chamber->id}}</td>
                            <td class="text-center">{{$chamber->chamber_name}}</td>
                            <td>{{$chamber->district_id}}</td>
                            <td>{{$chamber->thana_id}}</td>
                            <td> <a href="{{route('bvon.doctor.chamber.edit', $chamber->id)}}" >Edit</a><br> <a class="deleteDoctorInfo" href="javascript:void(0)" data-id="{{$chamber->id}}">Delete</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
