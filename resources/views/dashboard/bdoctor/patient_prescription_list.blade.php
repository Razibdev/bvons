    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">View Doctor <small></small></h3>
            </div>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    ...
                    @foreach($prescriptions as $prescription)
                        <tr>
                            ...
                            <td> <a href="#" >Edit</a><br> <a class="deleteDoctorInfo" href="javascript:void(0)" data-id="{{$prescription->id}}">Delete</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
