    ...
    <script>
        $(function() {
            $('#all-request-datatables').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('user_verification.bp_request_accepted.datatables') !!}',
                columns: [
                    { data: 'id', name: 'id' },
                    ...
                    { data: 'verified_date', name: 'user_verifications.verified_date'},
                    { data: 'referral_id', name: 'users.referral_id' },
