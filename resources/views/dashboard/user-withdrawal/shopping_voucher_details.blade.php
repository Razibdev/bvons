...
@section('js_after')
    ...
    <script>
        $(document).ready(function () {
            $(".shopping_voucher_add_minus").on("click", function () {
...
@section('content')
    <!-- Page Content -->
    <div class="content">
        <h2 class="content-heading">Shopping Voucher Full Transaction Details <button class="shopping_voucher_add_minus">Add or Minus Transaction</button></h2>
                ...
                <div class="block">
                    ...
                    <div class="paymentBalance">
                        <div class="payment-wrapper">
                            <form action="{{route('user_withdrawal.shopping.voucher.balance')}}" method="post"> {{csrf_field()}}
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            @if($transactions->count())
                                                ...
                                                <tr style="border-top: 2px solid #222;">
                                                    ...
                                                    <th>{{ $user->shoppingVoucherBalance() }}</th>
                                                </tr>
