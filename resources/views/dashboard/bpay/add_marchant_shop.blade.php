    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content block-content-full">
                ...
                <form action="{{route('bvon.bpay.add.marchant.shop')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="organize_name" id="organize_name" class="form-control" placeholder="Enter Organize Name" required value="{{old('organize_name')}}">
                    </div>

                    <div class="form-group">
                        <label for="organize_address">Organize Address</label>
                        <input type="text" name="organize_address" id="organize_address" class="form-control" placeholder="Enter Organize Address" required value="{{old('organize_address')}}">
                    </div>


                    <div class="form-group">
                        <label for="mobile">Organize Marchant Mobile</label>
                        <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Enter Organize Marchant Mobile" required value="{{old('mobile')}}">
                    </div>

                    <div class="form-group">
                        <label for="percentage">Organize Marchant Percentage</label>
                        <input type="text" name="percentage" id="percentage" class="form-control" placeholder="Enter Commision Percentage" required value="{{old('percentage')}}">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="percentage">Marchant Percentage</label>
