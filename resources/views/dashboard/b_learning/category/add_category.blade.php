            ...
            <div class="col-md-8">
                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        <form action="{{route('blearning.categories.create')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="example-nf-email">Category Name</label>
                                <input type="text" class="form-control" id="example-nf-email" name="name" placeholder="Enter Category Name" required>
                            </div>
