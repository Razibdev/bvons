            ...
            <div class="col-md-8">
                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        <form action="{{route('blearning.subject.create')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summary-ckeditor" name="content_description"></textarea>
                            </div>
