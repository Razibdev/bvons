                        ...
                        <table class="table table-bordered" id="dealer-product-stock-active">
                            ...
                            @foreach($exams as $exam)
                                <tr>
                                    ...
                                    <td>{{$exam->duration}}</td>
                                    <td>
                                        <a href="{{route('quizze.exam.add.question', $exam->id)}}">Add Question</a> <br>
                                        <a href="{{route('quizze.exam.view.question', $exam->id)}}">View Question</a>
                                    </td>
                                    <td>
                                        <a href="{{route('quizze.edit.exam', $exam->id)}}">Edit</a>&nbsp
                                        &nbsp;<form
                                                action="{{route('quizze.exam.delete', $exam->id)}}" method="post"> {{csrf_field()}}
