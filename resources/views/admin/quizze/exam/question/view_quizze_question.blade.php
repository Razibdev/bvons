                        ...
                        <table class="table table-bordered" id="dealer-product-stock-active">
                            ...
                            @foreach($quizzes as $quizze)
                                <tr>
                                    <td>{{$i}}</td>
                                    <?php $i++; ?>
                                    <td>{{$quizze->question_name}}</td>
                                    <td>{{$quizze->option1}}</td>
                                    <td>{{$quizze->option2}}</td>
                                    <td>{{$quizze->option3}}</td>
                                    <td>{{$quizze->option4}}</td>
                                    <td>{{$quizze->answer}}</td>
                                    <td>
                                        <div class="input-group">
                                            &nbsp; &nbsp;<form
                                                    action="{{route('quizze.exam.quizze.question.delete', $quizze->id)}}" method="post"> {{csrf_field()}}
