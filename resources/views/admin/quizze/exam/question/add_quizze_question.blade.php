...
@section('content')
    ...
    <div class="content">
        <!-- Bootstrap Design -->
        <h2 class="content-heading">Exam Quizze Question</h2>
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Exam Quizze Question Add</h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <form action="{{route('quizze.add.quizze.exam.question.mcq')}}" method="post">{{csrf_field()}}
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <form action="{{route('quizze.add.quizze.exam.question.boolean')}}" method="post"> {{csrf_field()}}
                                            <div class="form-group">
                                                <label for="">Question Title</label><br>
                                                <input type="text" name="question_name" class="form-control" placeholder="Enter Question Name">
                                    ...
                                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                        <form action="{{route('quizze.add.quizze.exam.question.written')}}" method="post"> {{csrf_field()}}
                                            <div class="form-group">
                                                <label for="">Question Title</label><br>
                                                <input type="text" name="question_name" class="form-control" placeholder="Enter Question Name">
