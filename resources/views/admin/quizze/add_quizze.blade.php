...
@section('content')
    ...
    <div class="content">
        <!-- Bootstrap Design -->
        <h2 class="content-heading">add user for quizze</h2>
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Quizze</h3>
                    ...
                    <div class="block-content">
                        ...
                        <form action="{{route('quizze.add.user')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">

                                    <div class="form-group">
                                        <label for="category_name">User Choose<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="quizze" value="1">
                                    </div>


                                    <div class="form-group">
                                        <label for="media">Quizze Exam Access<span class="text-danger">*</span> &nbsp; &nbsp;</label>
                                        <input type="checkbox" name="quizze_exam" value="1">
                                    </div>
