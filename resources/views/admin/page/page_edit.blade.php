            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        ...
                        <form action="{{route('page.page.edit', $page->id)}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="admin_id[]" id="admin_id" class="form-control js-example-basic-multiple" multiple="multiple" >
                                            @foreach($users as $key => $user)
                                                ...
                                                <option value="{{$user->id}}"  <?php   $admin = explode(",", $page->admin_id); for($i=0; $i < count($admin); $i++){  $admins = $admin[$i]; ?> @if($user->id == $admins) selected @endif <?php  }  ?> >{{$user->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
