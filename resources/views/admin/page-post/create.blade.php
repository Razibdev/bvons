            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Post Add</h3>
                    ...
                    <div class="block-content">
                        ...
                        <form class="js-validation-bootstrap" enctype="multipart/form-data" action="{{route('page.post.add')}}" method="post" >
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="page_name" id="page_name" class="form-control">
                                            @foreach($page as $pa)
                                                @foreach($pa as $pag)
                                                    <option value="{{$pag->id}}">{{$pag->page_name}}</option>
                                                @endforeach
                                            @endforeach
                                        </select>
                                        </div>
