@extends('ecommerce.eco_layout.simple')
                ...
                <div class="content content-full overflow-hidden">
                    ...
                    <div class="py-30 text-center">
                        <a class="link-effect font-w700" href="">
                            ...
                            <span class="font-size-xl text-primary-dark">{{ env('APP_NAME') }}</span>
                        </a>
                        <h1 class="h4 font-w700 mt-30 mb-10">Welcome to {{ env('APP_NAME') }}</h1>
