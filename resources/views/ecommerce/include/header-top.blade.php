 @php
 $all = App\Model\Ecommerce\Api\EcoOrder::where('seen_status',1)->limit(4)->get();
 $count = App\Model\Ecommerce\Api\EcoOrder::where('seen_status',1)->count();
 //echo $count;
 @endphp
         ...
         <div class="content-header-section">
             ...
             <div class="btn-group" role="group">
                 ...
                 <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                     ...
                     <div class="dropdown-divider"></div>
                     @include('ecommerce.include.logout-button')
                 </div>
             </div>
             <!-- END User Dropdown -->
             ...
             <div class="btn-group" role="group">
                 ...
                 <div class="dropdown-menu dropdown-menu-right min-width-300" aria-labelledby="page-header-notifications">
                     ...
                     <div class="dropdown-divider"></div>
                     <a class="dropdown-item text-center mb-0" href="{{route('orders.index')}}">
                         <i class="fa fa-flag mr-5"></i> View All Order
                     </a>
                 </div>
             </div>
             <!-- END Notifications -->
