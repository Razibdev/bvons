...
@section('content')
    ...
    <div class="checkout-main-page">
        ...
        <div class="checkout">
            ...
            <div class="row">
                ...
                <div class="checkout-single">
                    <img src="{{asset('/storage/'.$cart->product_image)}}" width="80" height="100"  alt="">
                </div>
        ...
        <div class="sidebar-order-checkout">
            ...
            <div class="method">
                <h4 id="method">Shipping Method</h4>
            ...
            <div class="checkout-now-button">
                ...
                <div class="other-order">
                    <a href="{{url('/others-order')}}">Other Orders</a>
                </div>
                    @endif
            </div>
            ...
            $('#billing_city').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#billing_thana').empty();
                        $('#billing_thana').append(`<option style="color: #444;" value="0" disabled selected>Select Billing Thana*</option>`);
                        response.forEach(element => {
                            $('#billing_thana').append(`<option style="color: #444;" value="${element['id']}">${element['name']}</option>`);
                    });
                    }
                });
            });
            ...
            $('#shipping_city').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#shipping_thana').append(`<option style="color: #444;" value="0" disabled selected>Select Shipping Thana*</option>`);
                        response.forEach(element => {
                            $('#shipping_thana').append(`<option style="color: #444;" value="${element['id']}">${element['name']}</option>`);
                    });
                    }
                });
            });
