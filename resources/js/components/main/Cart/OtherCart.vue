                    ...
                    >
                        <v-card-text>
                            ...
                            <div class="order_summery_second">
                                <ul>
                                    <li v-for=" item in cart" :key="item.id">{{item.product_name}} <span>Tk. {{item.product.user_price}}</span></li>
                                </ul>
                            </div>
                            <div class="order_summery_second">
                                <ul>
...
<script>
    export default {
        data: () => ({
            ...
            menu: false,
            items: ['9.00 am - 8.00pm', '9.00 am - 8.00pm'],
            radios: 1,
            area: [],
            selectDistrict: '',
            form:{
        ...
        methods:{
            orderComplete(){
                this.$store.dispatch('orderComplete', {
                    ...
                    total : this.$store.getters.otherTotoalPrice,
        ...
        computed: {
            ...
            cartTotalPrice(){
                return this.$store.getters['otherTotoalPrice'];
            },
