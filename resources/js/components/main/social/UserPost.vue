<template>
    <div >
        <div>
            <v-layout row wrap style="margin-left: 15px; " >
                <v-flex xs12 md6 style="margin-top: 18px;">
                    <v-form @submit.prevent="createNewPost" enctype="multipart/form-data" method="POST">
                        <v-layout row wrap>
                            ...
                            <v-flex xs12 md4 style="margin-top: 10px; margin-bottom: 10px;">
                                <input type="file" @change="onFileChange" label="File input" >
                            </v-flex>
                            <v-flex xs12 md4 style="margin-bottom: 5px">
                ...
                <v-flex xs12 md6 style="margin-top: 10px; margin-left: -10px;">
                    <v-layout>
                        <v-flex xs10 md10>
                            <v-autocomplete
                                    :items="allUserGet"
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            userSearchFilter(){
              // alert(this.userFilter);
                this.$router.push({name:'vue-social-main-sprofile', id:this.userFilter});
            },
            getImgUrl(id, image){
        ...
        created() {
            ...
            console.log(this.$store.state.authUserAllPost)
        },
        computed:{
            AuthUserPosts(){
