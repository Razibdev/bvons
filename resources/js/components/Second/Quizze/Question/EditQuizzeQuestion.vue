    ...
    <section>
        ...
        <div class="main">
            ...
            <div>
                ...
                <v-form @submit.prevent="editQuestionSubmit" method="post">
                    <v-row>
                        ...
                        <v-row style="padding-left: 10px;  padding-right: 10px;"  v-if="singleQuestionExam.type === 'mcq'">
                        ...
                        <v-row style="padding-left: 10px; padding-right: 10px;" v-if="singleQuestionExam.type === 'boolean'">
                            <v-col class="selectinput" cols="12" md="6">
                                <v-text-field label="Enter Option One" v-model="form.answer_option1" solo></v-text-field>
                            </v-col>
                        ...
                        <v-row style="padding-left: 10px;  padding-right: 10px;" v-if="singleQuestionExam.type === 'written'">
                            <v-col class="selectinput" cols="12" md="12">
                                <v-text-field label="Enter Option One" v-model="form.answer_option1" solo></v-text-field>
                            </v-col>
                        </v-row>
...
<script>
    export default {
        ...
        methods:{
            ...
            editQuestionSubmit(){
                axios.post(`/api/bvon-quizze/edit-quizze-exam-question-update/${this.$route.params.id}/${this.$route.params.examId}`, this.form)
                    .then(res => {
        ...
        mounted(){
            ...
            axios.get(`/api/bvon-quizze/view-quizze-exam-single-question/${this.$route.params.id}/${this.$route.params.examId}`)
                .then(res => {
                    this.singleQuestionExam = res.data;
