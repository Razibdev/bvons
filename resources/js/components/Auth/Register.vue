        ...
        >
            <template v-slot:activator="{ on, attrs }">
                <a
                        ...
                        v-bind="attrs"
                        v-on="on"
                        style="padding: 1px; background: teal; border-radius: 5px; color: #ffffff;"
...
<script>
    export  default {
        ...
        methods:{
            ...
            loginFormClose(){
                this.dialog1 = true;
                EventBus.$emit('loginFormClose', this.dialog1);
            }
